sap.ui.define([
	...
	//return Controller.extend("myview.Tile", {
		...
		onInit: function(){
            ...
            if (oTileApi.configurationUi.isEnabled()) {
                oTileApi.configurationUi.setUiProvider(function () {
                    ...
                    var oConfigurationUi = sap.ushell.components.tiles.utils.getConfigurationUi(oView, "convista.com.demo.dynamictile.twobyone.view.Configuration");
			...
			switch(oConfig.frame_type){
        		...
        		case "twoByOne1":
        			...
        			if(!oConfig.display_tile_content_xml || oConfig.display_tile_content_xml === ""){
						// content of the tile
						this.tileContent = sap.ui.xmlfragment("convista.com.demo.dynamictile.twobyone.view.MicroChartDemo",this);
					}
					// Input on XML AREA
					else{
						try{
        		...
        		case "twoByOne2":
        			...
        			if((!oConfig.display_tile_content_xml || oConfig.display_tile_content_xml === "")&&(!oConfig.display_second_tile_content_xml || oConfig.display_second_tile_content_xml !== "")){
						...
						this.tileContent = sap.ui.xmlfragment("convista.com.demo.dynamictile.twobyone.view.MicroChartDemo",this);
						this.tileSecondContent = sap.ui.xmlfragment("convista.com.demo.dynamictile.twobyone.view.MicroChartDemo",this);
					}
...
/*            if (this.oDataRequest) {
                ...
                if(urlIsAbsolute){
					...
					if(sUrl2 !== ""){
						jQuery.ajax({
		    				...
		    				cache: false,
		    				success: function(json){
		    					that.handleSecondServiceCallback(json, that);
							}
						});
					}
                }
        ...
        handleSecondServiceCallback: function(json, that){
